<template>
    <div class="sidebar">
        ...
        <router-link to="/tong-quan" @click="selected = 1" :class="{'sidebar-menu--selected':selected == 1}" class="sidebar-menu position-relative">
        ...
        <router-link to="/tai-san" @click="selected = 2" :class="{'sidebar-menu--selected':selected == 2}" class="sidebar-menu position-relative">
        ...
        <router-link to="" @click="selected = 3" :class="{'sidebar-menu--selected':selected == 3}" class="sidebar-menu position-relative">
        ...
        <router-link to="" @click="selected = 4" :class="{'sidebar-menu--selected':selected == 4}" class="sidebar-menu position-relative"> 
        ...
        <router-link to="" @click="selected = 5" :class="{'sidebar-menu--selected':selected == 5}" class="sidebar-menu position-relative">
        ...
        <router-link to="" @click="selected = 6" :class="{'sidebar-menu--selected':selected == 6}" class="sidebar-menu position-relative">
        ...
        <router-link to="/bao-cao" @click="selected = 7" :class="{'sidebar-menu--selected':selected == 7}" class="sidebar-menu position-relative">
